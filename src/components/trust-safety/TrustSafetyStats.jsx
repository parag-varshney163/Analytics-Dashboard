...
//   );
// }
import { Flag, TriangleAlert, ShieldCheck, MessageSquareWarning, Headset, Clock3, } from "lucide-react";
import React from "react";
  ...
  const stats = [
    {
      ...
      value: data.flagsToday?.yesterday?.toLocaleString() || "0",
      previousValue:
        data.flagsToday?.beforeYesterday?.toLocaleString() || "0",
      change: data.flagsToday?.change,
      icon: Flag,
    },
    {
      ...
      value: data.pendingReview?.yesterday?.toLocaleString() || "0",
      previousValue:
        data.pendingReview?.beforeYesterday?.toLocaleString() || "0",
      change: data.pendingReview?.change,
      icon: TriangleAlert,
    },
    {
      ...
      value: data.resolvedToday?.yesterday?.toLocaleString() || "0",
      previousValue:
        data.resolvedToday?.beforeYesterday?.toLocaleString() || "0",
      change: data.resolvedToday?.change,
      icon: ShieldCheck,
    },
    {
      ...
      value: data.chatFlags?.yesterday?.toLocaleString() || "0",
      previousValue:
        data.chatFlags?.beforeYesterday?.toLocaleString() || "0",
      change: data.chatFlags?.change,
      icon: MessageSquareWarning,
    },
    {
      ...
      value: data.supportTickets?.yesterday?.toLocaleString() || "0",
      previousValue:
        data.supportTickets?.beforeYesterday?.toLocaleString() || "0",
      change: data.supportTickets?.change,
      icon: Headset,
    },
    {
      title: "Avg Resolution",
      value: `${data.avgResolution?.yesterday || 0} mins`,
      previousValue: `${data.avgResolution?.beforeYesterday || 0} mins`,
      change: data.avgResolution?.change,
      icon: Clock3,
    },
  ];
