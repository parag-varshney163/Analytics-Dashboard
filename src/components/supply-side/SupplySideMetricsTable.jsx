...
const SupplySideMetricsTable = ({ data }) => {
  ...
  const tableData = [
    ...
    {
      metric: "Level 3 Creators Online",
      yesterday: yesterday.level3CreatorsOnline,
      beforeYesterday: beforeYesterday.level3CreatorsOnline,
      sevenDays: sevenDays.level3CreatorsOnline,
      change: change.level3CreatorsOnline?.text,
    },
    {
      metric: "Level 4 Creators Online",
      yesterday: yesterday.level4CreatorsOnline,
      beforeYesterday: beforeYesterday.level4CreatorsOnline,
      sevenDays: sevenDays.level4CreatorsOnline,
      change: change.level4CreatorsOnline?.text,
    },
    {
      metric: "Level 5 Creators Online",
      yesterday: yesterday.level5CreatorsOnline,
      beforeYesterday: beforeYesterday.level5CreatorsOnline,
      sevenDays: sevenDays.level5CreatorsOnline,
      change: change.level5CreatorsOnline?.text,
    },
    {
